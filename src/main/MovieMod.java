...
public class MovieMod extends MovieDisplay {
    ...
    public static void createMovieListing(Scanner input){
        ...
        System.out.println("Enter Ticket Sales:");
        double sales = input.nextDouble();
        if(createNewMovie(movieid, moviename, language, new ArrayList<Integer>(), runtime, cast, director,Synopsis,new ArrayList<String>(), status,sales))
    ...
    private static Boolean createNewMovie(int id, String name, String Language, ArrayList<Integer> rating, String runTime, List<String> cast, String Synopsis, String Director,ArrayList<String> reviews, String status, double sales){
        Movie m = new Movie(id, name, Language, rating, runTime, cast, Director,Synopsis,reviews, status,sales);
