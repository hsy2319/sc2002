        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (tokens[1].toLowerCase().contains(search.toLowerCase())) {
                    ...
                    Movie movie = new Movie(Integer.parseInt(tokens[0]), tokens[1], tokens[2],ratings, tokens[4], cast, tokens[6], tokens[7],reviews,tokens[9],Double.parseDouble(tokens[10]));
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (Found) {
                    ...
                    writer.append(",");
                    writer.append(String.valueOf(movie.getSales()));
                    writer.append("\n");
                    Found = false;
