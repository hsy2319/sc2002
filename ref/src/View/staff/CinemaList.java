...
public class CinemaList extends View {
    ...
    private void displayMenu() {
        printTitle("Configure cinemas");
        printChoices("1. List cinemas",
                "2. Add cinemas",
                "3. Go back", "");
    ...
    private void displayCinemaListMenu() {
        ...
        printChoices("Choose a cineplex to view cinema codes:");
    ...
    private void displayCinemaList(Cineplex cineplex) {
        printTitle(cineplex.toString());
        ArrayList<Cinema> cinemaList = getCinemaList(cineplex);

        if (cinemaList == null) {
            printChoices("No cinema found.",
    ...
    private void addCinema() {
        ...
        printChoices("Choose a cineplex to add the cinema:");
        int choice = readChoice(1, index);
