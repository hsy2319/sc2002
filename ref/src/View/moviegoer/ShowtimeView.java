...
public class ShowtimeView extends View {
    ...
    private void displayMenu() {
        ...
        if (movie.getMovieStatus().equals(Constant.MovieStatus.NOW_SHOWING)) {
            printChoices("1. " + formatTimeMMdd(today) + " (today)",
            ...
            printChoices("1. " + formatTimeMMdd(tomorrow),
        ...
        printTitle("Showtime on " + formatTimeMMdd(dateChosen));
    ...
    private void displayShowtimeDetailMenu(Showtime showtime) {
        ...
        printChoices("1. Check seat availability",
                "2. Book seat",
                "3. Check price",
                "4. Go back", "");
    ...
    private void showPrice(Showtime showtime) {
        ...
        printTitle("Ticket price for " + movie.getTitle() + " (" + (showtime.getCinema().is3D() ? "3D" : "Digital") + ")");
